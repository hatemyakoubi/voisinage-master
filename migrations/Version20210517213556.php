 ...
 */
final class Version20210517213556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_27FFFF07A76ED395 ON user_image');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_image ADD user_id INT DEFAULT NULL');
