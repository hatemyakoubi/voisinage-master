 ...
 */
final class Version20210425140900 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP nom, DROP prenom, DROP adress, DROP telephone, DROP image, CHANGE email email VARCHAR(180) NOT NULL, CHANGE enabled enabled VARCHAR(255) NOT NULL');
